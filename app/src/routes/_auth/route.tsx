...
import { usePostHogIdentify } from "#/components/analytics/posthog";
...
function AuthLayout() {
  // The user is already loaded by beforeLoad, so this identifies them in
  // PostHog without any extra fetch.
  usePostHogIdentify();
  return <Outlet />;
}
